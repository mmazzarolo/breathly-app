...
import { changeNavigationBarColor } from "../../utils/change-navigation-bar-color";
import { ButtonAnimator } from "../button-animator/button-animator";
import { Exercise } from "../exercise/exercise";
import { Menu } from "../menu/menu";
import { Settings } from "../settings/settings";
import { TechniquePicker } from "../technique-picker/technique-picker";
